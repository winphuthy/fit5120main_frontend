            ...
            <p>In this page, we’ll be going through the steps you might need to take to install and begin utilising
                ...
                <div ref={zoomRef}>
                    <div>
                        ...
                        <p>Step 1: On your Web browser, navigate to the top of it, and click the “+”icon to open a new tab </p>
                        <p>Step 2: Within the empty address bar at the top of the tab, enter the following link: “https://www.zoom.us/DOWNLOAD ”.  </p>
                    </div>
                    <div style={{margin: "30px 0px"}}>
