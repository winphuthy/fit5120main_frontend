            ...
            <div className='maincontent'>
                ...
                <div ref={whatsappRef}>
                    <div>
                        ...
                        <p>WhatsApp is a messaging app that allows users to send text messages, voice messages, photos,
                            videos,
                            and documents, as well as make voice and video calls, to other users who have the app
                            installed on
                            their smartphones. WhatsApp can be used for personal and business communication, as well as
                            for
                ...
                <div ref={zoomRef}>
                    <div>
                        ...
                        <p>Zoom is a video conferencing platform that enables users to hold group calling sessions. It
                            can be used for video and audio meetings, screen sharing, recording, and just simply
                            chatting. Zoom is most commonly used for conference calls, but is also oftentimes used for
                            large family calls, especially for including overseas family members.</p>
                ...
                <div ref={facebookRef}>
                    <div>
                        ...
                        <p>Facebook is a social media platform that allows you to create your own personal profile. It
                            will allow you to connect with your families and friends, allowing you to share photos and
                            videos, and view photos and videos by other users. It helps people keep one another updated
                            with what’s going on in their lives. Facebook can also be used as a messaging service to
                            communicate with your facebook friends.</p>
                    </div>
                    <div style={{margin: "30px 0px"}}>
                ...
                <div ref={facetimeRef}>
                    <div>
                        ...
                        <p>FFacetime is a video and audio calling platform. It also allows for group calls and group
                            video calls, meaning that multiple people can be connected to the same call at the same
                            time. It is only available on apple devices (e.g. iPhones, iPads, Macbooks). For an
                            alternative if you are not using an Apple device, please reference our “WhatsApp” section
                            for details regarding a similar tool. </p>
                    </div>
                    <div style={{margin: "30px 0px"}}>
