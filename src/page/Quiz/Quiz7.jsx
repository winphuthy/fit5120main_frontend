...
export function Quiz7() {
    ...
    return (
        <div style={{backgroundColor: 'darkgray',paddingTop: '50px', height: '100vh', width: '100vw'}}>
            ...
            <h2 style={{color:'orange'}}>Question 7 of 10</h2>
            ...
            <Button variant="contained" sx={{width: '300px',marginTop: '50px', marginLeft: 'auto', marginRight: 'auto', display: 'block', backgroundColor: 'orange'}} onClick={() => window.location.href='quiz8'}>NEXT</Button>            
            </div>
        </div>
    );
}