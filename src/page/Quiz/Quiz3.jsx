...
export function Quiz3() {
    ...
    const currentQuestion = multiQuiz[2]; // get the first question from MultiQuiz
    ...
    return (
        <div style={{backgroundColor: 'darkgray',paddingTop: '50px', height: '100vh', width: '100vw'}}>
            ...
            <Button variant="contained" sx={{width: '300px',marginTop: '50px', marginLeft: 'auto', marginRight: 'auto', display: 'block', backgroundColor: 'orange'}} onClick={() => window.location.href='quiz4'}>NEXT</Button>            </div>
        </div>
    );
}